...
public class Feedback {
	public static String getCode(final String directory) {
		String code = "<img src=\"" + directory + "/like.png\" onClick=\"wiSendFeedback(1);\" alt=\"Stránka ma zaujala\" width=\"30\" height=\"30\"/>";
		code += "<img src=\"" + directory + "/dislike.png\" onClick=\"wiSendFeedback(-1);\" alt=\"Stránka ma nezaujala\" width=\"30\" height=\"30\"/>";
		/*
